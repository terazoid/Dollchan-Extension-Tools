...
true, true];
		...
		_createClass(CacheItem, [{
				...
				return regeneratorRuntime.wrap(function refLinks$(_context23) {
					while (1) {
						switch (_context23.prev = _context23.next) {
							case 0:
								return _context23.delegateYield(this._pBuilder.getRefLinks(this.count, this._thrUrl), 't0', 1);
			...
			get: function get() {
				...
				if (this.isOp) {
					...
					value = { lastNum: this._pBuilder.getPNum(pcount - 1), pcount: pcount };
					Object.defineProperty(value, 'title', { get: function get() {
							return _this56.title;
						} });
				}
				Object.defineProperty(this, 'thr', { value: value });
				return value;
			}
		}]);
	...
	var PviewsCache = function (_TemporaryContent2) {
		...
		function PviewsCache(pBuilder, b, tNum) {
			...
			var _this57 = _possibleConstructorReturn(this, (PviewsCache.__proto__ || Object.getPrototypeOf(PviewsCache)).call(this, b + tNum));
			...
			value: function srcBtnEvents(_ref58) {
				...
				srcBtnEl.addEventListener('mouseover', function () {
					return srcBtnEl.odelay = setTimeout(function () {
						var menuHtml = !_this63.isVideo ? Menu.getMenuImgSrc(srcBtnEl) : '<span class="de-menu-item">' + Lng.getFrameLinks[lang] + '</span>';
		...
		_createClass(Thread, [{
			...
			value: function loadPosts(task) {
				...
				return ajaxPostsLoad(aib.b, this.num, false).then(function (pBuilder) {
					return _this67._loadFromBuilder(task, isSmartScroll, pBuilder);
				}, function (err) {
			...
			value: function loadNewPosts() {
				...
				return ajaxPostsLoad(aib.b, this.num, true).then(function (pBuilder) {
					return pBuilder ? _this68._loadNewFromBuilder(pBuilder) : { newCount: 0, locked: false };
				});
			}
		}, {
			key: 'toggleFavState',
			...
			value: function _toggleReplies() {
				...
				$each(this.btns.children, function (el) {
					return el !== _this69.btnReplies && $toggle(el, !isHide);
				});
		...
		_expandCollapse: function _expandCollapse(isExpand, rt) {
			...
			if (!rt || !this._el.contains(rt.farthestViewportElement || rt)) {
				...
				this._toggleTO = setTimeout(function () {
					return _this71._el.classList.toggle('de-thr-navpanel-hidden', !isExpand);
				}, Cfg.linksOver);
			}
		},
		...
		var counter = {
			count: function count(delayMS, useCounter, callback) {
				...
				this._countingIV = setInterval(function () {
					seconds--;
					if (seconds === 0) {
						_this74._stopCounter();
						callback();
					} else {
						_this74._set(seconds);
					}
				}, 1e3);
			},
		...
		var favicon = {
			...
			initIcons: function initIcons() {
				...
				icon.onload = function (e) {
					try {
						_this75._initIconsHelper(e.target);
					} catch (err) {
			...
			startBlink: function startBlink(isError) {
				...
				this._blinkInterv = setInterval(function () {
					return _this76._setIcon((_this76._isOrigIcon = !_this76._isOrigIcon) ? _this76.originalIcon : _this76._currentIcon);
				}, this._blinkMS);
			},
			...
			_initIconsHelper: function _initIconsHelper(icon) {
				...
				this._getIconNew = function (newPosts) {
					...
					return _this77._iconsNew[id] || (_this77._iconsNew[id] = _this77._drawIconsNewYou(ctx, canvas, id, iconNewCircle, scale));
				};
				this._getIconYou = function (newPosts) {
					var id = newPosts < 10 ? newPosts : 0;
					return _this77._iconsYou[id] || (_this77._iconsYou[id] = _this77._drawIconsNewYou(ctx, canvas, id, iconYouCircle, scale));
				};
				this._hasIcons = true;
			},
		...
		var notification = {
			...
			showNotif: function showNotif() {
				...
				notif.onshow = function () {
					return setTimeout(function () {
						return notif === _this78._notifEl && _this78.closeNotif();
					}, 12e3);
				};
	...
	function getImageBoard(checkDomains, checkEngines) {
		...
		var Kusaba = function (_BaseBoard) {
			...
			function Kusaba(prot, dm) {
				...
				var _this81 = _possibleConstructorReturn(this, (Kusaba.__proto__ || Object.getPrototypeOf(Kusaba)).call(this, prot, dm));

				_this81.kusaba = true;

				_this81.qError = 'h1, h2, div[style*="1.25em"]';
				_this81.qFormRedir = 'input[name="redirecttothread"][value="1"]';

				_this81.formParent = 'replythread';
		...
		var Tinyboard = function (_BaseBoard2) {
			...
			function Tinyboard(prot, dm) {
				...
				var _this82 = _possibleConstructorReturn(this, (Tinyboard.__proto__ || Object.getPrototypeOf(Tinyboard)).call(this, prot, dm));

				_this82.cReply = 'post reply';
				_this82.qClosed = '.fa-lock';
				_this82.qDForm = 'form[name*="postcontrols"]';
				_this82.qForm = 'form[name="post"]';
				_this82.qFormPassw = 'input[name="password"]:not([type="hidden"])';
				_this82.qFormRedir = null;
				_this82.qImgInfo = '.fileinfo';
				_this82.qOmitted = '.omitted';
				_this82.qPages = '.pages';
				_this82.qPostHeader = '.intro';
				_this82.qPostMsg = '.body';
				_this82.qPostName = '.name';
				_this82.qPostRef = '.post_no + a';
				_this82.qPostSubj = '.subject';
				_this82.qPostTrip = '.trip';
				_this82.qTrunc = '.toolong';
				_this82._origInputs = null;
				_this82._qOPostEnd = '.post.reply';

				_this82.firstPage = 1;
				_this82.formParent = 'thread';
				_this82.hasCatalog = true;
				_this82.hasRefererErr = true;
				_this82.jsonSubmit = true;
				_this82.timePattern = 'nn+dd+yy++w++hh+ii+ss';
				return _this82;
			}
			...
			_createClass(Tinyboard, [{
								...
								switch (_context30.prev = _context30.next) {
									...
									case 5:
										...
										$each($Q(query, form), function (el) {
											return _this83._origInputs[0].appendChild(el);
										});
										_context30.next = 17;
										break;
									...
									case 17:
										...
										return ajaxLoad(aib.getThrUrl(this.b, tNum), false).then(function (loadedDoc) {
											var loadedForm = $q(_this83.qForm, loadedDoc);
											if (!loadedForm) {
												errFn();
												return;
											}
											pr.subm.value = $q(_this83.qFormSubm, loadedDoc).value;
											$delAll(query, form);
				...
				value: function fixVideo(isPost, data) {
					...
					return Array.from($Q('.video-container, #ytplayer', isPost ? data.el : data), function (el) {
						var value = [isPost ? data : _this84.getPostOfEl(el), el.id === 'ytplayer' ? el.src.match(Videos.ytReg) : ['', el.getAttribute('data-video')], true];
						el.remove();
						return value;
					});
				}
		...
		var Vichan = function (_Tinyboard) {
			...
			function Vichan(prot, dm) {
				...
				var _this85 = _possibleConstructorReturn(this, (Vichan.__proto__ || Object.getPrototypeOf(Vichan)).call(this, prot, dm));

				_this85.qDelPassw = '#password';
				_this85.qPostImg = '.post-image[alt]:not(.deleted)';
		...
		var TinyIB = function (_BaseBoard3) {
			...
			function TinyIB(prot, dm) {
				...
				var _this86 = _possibleConstructorReturn(this, (TinyIB.__proto__ || Object.getPrototypeOf(TinyIB)).call(this, prot, dm));

				_this86.qError = 'body[align=center] div, div[style="margin-top: 50px;"]';
				_this86.qPostImg = 'img.thumb, video.thumb';
				_this86.qPostMsg = '.message';
				return _this86;
			}
		...
		var Lynxchan = function (_BaseBoard4) {
			...
			function Lynxchan(prot, dm) {
				...
				var _this88 = _possibleConstructorReturn(this, (Lynxchan.__proto__ || Object.getPrototypeOf(Lynxchan)).call(this, prot, dm));
				...
				_this88.qFormRules = '.form-post > .small';
				_this88.qFormSubm = '#formButton, #de-postform-submit';
				_this88.qImgInfo = '.uploadDetails';
				_this88.qOmitted = '.labelOmission';
				_this88.qOPost = '.innerOP';
				_this88.qPages = '#divPages';
				_this88.qPostHeader = '.postInfo, .de-post-btns';
				_this88.qPostImg = '.imgLink > img, img[src*="/.media/"]';
				_this88.qPostMsg = '.divMessage';
		...
		var FoolFuuka = function (_BaseBoard5) {
			...
			function FoolFuuka(prot, dm) {
				...
				var _this90 = _possibleConstructorReturn(this, (FoolFuuka.__proto__ || Object.getPrototypeOf(FoolFuuka)).call(this, prot, dm));

				_this90.cReply = 'post_wrapper';
				_this90.qDForm = '#main';
				_this90.qImgInfo = '.post_file_metadata, .thread_image_box > .post_file';
				_this90.qOmitted = '.omitted_text';
				_this90.qPages = '.paginate > ul > li:nth-last-child(3)';
				_this90.qPostHeader = 'header';
				_this90.qPostImg = '.post_image, .thread_image';
				_this90.qPostMsg = '.text';
				_this90.qPostRef = '.post_data > a[data-function="quote"]';
				_this90.qPostSubj = '.post_title';
				_this90.qPostsParent = '.posts';
				_this90.qRPost = '.post[id]';
				_this90._qOPostEnd = '.posts';
		...
		var _02ch = function (_Kusaba) {
			...
			function _02ch(prot, dm) {
				...
				var _this91 = _possibleConstructorReturn(this, (_02ch.__proto__ || Object.getPrototypeOf(_02ch)).call(this, prot, dm));
		...
		var _2__ch = function (_BaseBoard6) {
			...
			function _2__ch(prot, dm) {
				...
				var _this92 = _possibleConstructorReturn(this, (_2__ch.__proto__ || Object.getPrototypeOf(_2__ch)).call(this, prot, dm));

				_this92.qPages = 'table[border="1"] td > a:last-of-type';
				_this92.qPostImg = 'img.thumb';
				_this92._qOPostEnd = 'table:not(.postfiles)';

				_this92.docExt = '.html';
				_this92.hasPicWrap = true;
				_this92.jsonSubmit = true;
		...
		var Makaba = function (_BaseBoard7) {
			...
			function Makaba(prot, dm) {
				...
				var _this93 = _possibleConstructorReturn(this, (Makaba.__proto__ || Object.getPrototypeOf(Makaba)).call(this, prot, dm));

				_this93.makaba = true;

				_this93.cReply = 'de-reply-class';
				_this93.qBan = '.post__pomyanem';
				_this93.qClosed = '.sticky-img[src$="locked.png"]';
				_this93.qDForm = '#posts-form';
				_this93.qFormFile = '.postform__raw.filer input[type="file"]';
				_this93.qFormRedir = null;
				_this93.qFormRules = '.rules';
				_this93.qFormSubm = '#submit';
				_this93.qFormTd = '.postform__raw';
				_this93.qFormTr = '.postform__raw';
				_this93.qFormTxta = '#shampoo';
				_this93.qImgInfo = '.post__file-attr';
				_this93.qOmitted = '.thread__missed';
				_this93.qOPost = '.post_type_oppost';
				_this93.qPostHeader = '.post__details';
				_this93.qPostImg = '.post__file-preview';
				_this93.qPostMsg = '.post__message';
				_this93.qPostName = '.post__anon, .post__email';
				_this93.qPostRef = '.post__reflink:nth-child(2)';
				_this93.qPostSubj = '.post__title';
				_this93.qRPost = '.post_type_reply[data-num]';
				_this93.qTrunc = null;
				...
				_this93.JsonBuilder = MakabaPostsBuilder;
				_this93.jsonSubmit = true;
				_this93.markupBB = true;
				_this93.multiFile = true;
				_this93.timePattern = 'dd+nn+yy+w+hh+ii+ss';
				...
				value: function initCaptcha(cap) {
					...
					if (!img || img.tagName !== 'IMG') {
						...
						_img2.onclick = function () {
							return _this94.updateCaptcha(cap);
						};
						inp.tabIndex = 999;
						cap.textEl = inp;
					}
				...
				get: function get() {
					...
					var value = function value(pNum, tNum) {
						return $q('input[type="button"]', $popup('edit-report', '<input name="comment" value="" placeholder="' + (pNum === tNum ? Lng.reportThr[lang] : Lng.reportPost[lang]) + '" type="text"> <input value="OK" type="button">')).onclick = function (e) {
							...
							formData.append('board', _this95.b);
		...
		var _2chan = function (_BaseBoard8) {
			...
			function _2chan(prot, dm) {
				...
				var _this96 = _possibleConstructorReturn(this, (_2chan.__proto__ || Object.getPrototypeOf(_2chan)).call(this, prot, dm));

				_this96.qDForm = 'form:not([enctype])';
				_this96.qForm = '#fm';
				_this96.qFormRedir = null;
				_this96.qFormRules = '.chui';
				_this96.qOmitted = 'font[color="#707070"]';
				_this96.qPostImg = 'a[href$=".jpg"] > img, a[href$=".png"] > img, a[href$=".gif"] > img';
				_this96.qPostRef = '.del';
				_this96.qRPost = 'td:nth-child(2)';

				_this96.docExt = '.htm';
				_this96.formParent = 'resto';
				return _this96;
			}
		...
		var _2channel = function (_Makaba) {
			...
			function _2channel(prot, dm) {
				...
				var _this97 = _possibleConstructorReturn(this, (_2channel.__proto__ || Object.getPrototypeOf(_2channel)).call(this, prot, dm));

				_this97._2channel = true;

				_this97.hasAltCaptcha = false;
				return _this97;
			}
		...
		var _2chRip = function (_BaseBoard9) {
			...
			function _2chRip(prot, dm) {
				...
				var _this98 = _possibleConstructorReturn(this, (_2chRip.__proto__ || Object.getPrototypeOf(_2chRip)).call(this, prot, dm));
		...
		var _410chan = function (_Kusaba2) {
			...
			function _410chan(prot, dm) {
				...
				var _this99 = _possibleConstructorReturn(this, (_410chan.__proto__ || Object.getPrototypeOf(_410chan)).call(this, prot, dm));

				_this99.qFormRedir = 'input#noko';
				_this99.qPages = '.pgstbl > table > tbody > tr > td:nth-child(2)';

				_this99.ru = true;
				_this99.hasCatalog = true;
				_this99.markupBB = false;
				_this99.timePattern = 'dd+nn+yyyy++w++hh+ii+ss';
			...
			_createClass(_410chan, [{
				...
				value: function updateCaptcha(cap) {
					...
					return cap.updateHelper('/api_adaptive.php?board=' + this.b, function (xhr) {
						...
						var src = img.getAttribute('src');
						img.src = '';
						img.src = _this100.getCaptchaSrc(src);
					});
				}
			}, {
				key: 'capLang',
		...
		var _4chan = function (_BaseBoard10) {
			...
			function _4chan(prot, dm) {
				...
				var _this101 = _possibleConstructorReturn(this, (_4chan.__proto__ || Object.getPrototypeOf(_4chan)).call(this, prot, dm));

				_this101._4chan = true;

				_this101.cReply = 'post reply';
				_this101.qBan = 'strong[style="color: red;"]';
				_this101.qClosed = '.archivedIcon';
				_this101.qDelBut = '.deleteform > input[type="submit"]';
				_this101.qError = '#errmsg';
				_this101.qForm = 'form[name="post"]';
				_this101.qFormRedir = null;
				_this101.qImgInfo = '.fileText';
				_this101.qOmitted = '.summary.desktop';
				_this101.qOPost = '.op';
				_this101.qPages = '.pagelist > .pages:not(.cataloglink) > a:last-of-type';
				_this101.qPostHeader = '.postInfo';
				_this101.qPostImg = '.fileThumb > img:not(.fileDeletedRes)';
				_this101.qPostName = '.name';
				_this101.qPostRef = '.postInfo > .postNum';
				_this101.qPostSubj = '.subject';
				_this101._qOPostEnd = '.replyContainer';

				_this101.anchor = '#p';
				_this101.docExt = '';
				_this101.firstPage = 1;
				_this101.formParent = 'resto';
				_this101.hasAltCaptcha = true;
				_this101.hasCatalog = true;
				_this101.hasTextLinks = true;
				_this101.JsonBuilder = _4chanPostsBuilder;
				_this101.res = 'thread/';
				_this101.timePattern = 'nn+dd+yy+w+hh+ii-?s?s?';
				return _this101;
			}
		...
		var _55chan = function (_Vichan) {
			...
			function _55chan(prot, dm) {
				...
				var _this102 = _possibleConstructorReturn(this, (_55chan.__proto__ || Object.getPrototypeOf(_55chan)).call(this, prot, dm));

				_this102.qFormRules = '.regras';

				_this102._capUpdPromise = null;
				return _this102;
			}
			...
			_createClass(_55chan, [{
				...
				key: 'css',
				get: function get() {
					return _get(_55chan.prototype.__proto__ || Object.getPrototypeOf(_55chan.prototype), 'css', this) + '\n\t\t\t\tinput.delete, #post-moderation-fields { display: initial !important; }';
				}
			}]);
		...
		var Arhivach = function (_BaseBoard11) {
			...
			function Arhivach(prot, dm) {
				...
				var _this104 = _possibleConstructorReturn(this, (Arhivach.__proto__ || Object.getPrototypeOf(Arhivach)).call(this, prot, dm));

				_this104.cReply = 'post';
				_this104.qDelBut = null;
				_this104.qDelPassw = null;
				_this104.qDForm = 'body > .container-fluid';
				_this104.qPostHeader = '.post_head';
				_this104.qPostImg = '.post_image > img';
				...
				value: function init() {
					...
					setTimeout(function () {
						...
						for (var i = 0, _len19 = delPosts.length; i < _len19; ++i) {
							var post = pByNum.get(_this105.getPNum(delPosts[i]));
							if (post) {
		...
		var Endchan = function (_Lynxchan) {
			...
			function Endchan(prot, dm) {
				...
				var _this110 = _possibleConstructorReturn(this, (Endchan.__proto__ || Object.getPrototypeOf(Endchan)).call(this, prot, dm));

				_this110.qTrunc = '.contentOmissionIndicator > p';
				return _this110;
			}
		...
		var Ernstchan = function (_BaseBoard13) {
			...
			function Ernstchan(prot, dm) {
				...
				var _this111 = _possibleConstructorReturn(this, (Ernstchan.__proto__ || Object.getPrototypeOf(Ernstchan)).call(this, prot, dm));

				_this111.cReply = 'post';
				_this111.qError = '.error > .info';
				_this111.qFormRedir = 'input[name="gb2"][value="thread"]';
				_this111.qFormSpoiler = 'input[type="checkbox"][name="spoilered"]';
				_this111.qOPost = '.thread_OP';
				_this111.qPages = '.pagelist > li:nth-last-child(2)';
				_this111.qPostHeader = '.post_head';
				_this111.qPostMsg = '.text';
				_this111.qPostSubj = '.subject';
				_this111.qPostTrip = '.tripcode';
				_this111.qRPost = '.thread_reply';
				_this111.qTrunc = '.tldr';
				_this111.docExt = '';
		...
		var Iichan = function (_BaseBoard14) {
			...
			function Iichan(prot, dm) {
				...
				var _this112 = _possibleConstructorReturn(this, (Iichan.__proto__ || Object.getPrototypeOf(Iichan)).call(this, prot, dm));

				_this112.iichan = true;
		...
		var Kropyvach = function (_Vichan3) {
			...
			function Kropyvach(prot, dm) {
				...
				var _this114 = _possibleConstructorReturn(this, (Kropyvach.__proto__ || Object.getPrototypeOf(Kropyvach)).call(this, prot, dm));
